...
public class Spin extends Command {
	...
	private double speedL, speedR, seconds, rotations;

	public Spin(double seconds, double lspeed, double rspeed) {
		this.speedL = lspeed;
		this.speedR = rspeed;
    ...
    public Spin(int rotations, double lspeed, double rspeed) {
		this.speedL = lspeed;
		this.speedR = rspeed;
