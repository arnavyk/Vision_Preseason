...
cv2.createTrackbar('Max Saturation','Tuner',255,255,nothing)
cv2.createTrackbar('Min Value','Tuner',255,255,nothing)
cv2.createTrackbar('Max Value','Tuner',255,255,nothing)
min_h = 0
min_s = 0
min_v = 0
max_h = 255
